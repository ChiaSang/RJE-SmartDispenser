...
void uart2_getDown_task(void *parameters)
{
  for (;;)
  {
    ...
    if (Serial2.available())
    {
      ...
      //------------------------------------------------------
      if (inputString.equals("down set_properties 2 4 1\r"))
      {
        runState = 1;
      ...
      if (inputString.equals("down set_properties 2 4 2\r"))
      {
        runState = 2;
        Serial2.write("result 2 4 0 2\r");
        Serial2.write("properties_changed 2 4 2\r");
      }

      if (inputString.equals("down set_properties 2 4 3\r"))
      {
        runState = 3;
      ...
      if (inputString.equals("down set_properties 2 6 3\r"))
      {
        Serial2.write("result 2 4 0 3\r");
        Serial2.write("properties_changed 2 4 3\r");
      }
